  ...
  return (
    <section ref={containerRef} className="relative min-h-[100svh] flex flex-col items-center justify-center pt-28 pb-20 overflow-hidden">
      ...
      <motion.div style={{ y: yBg }} className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-[-10%] left-[-5%] w-[45%] h-[45%] rounded-full bg-[#0E8991]/15 blur-[130px]" />
        <div className="absolute bottom-[10%] right-[-5%] w-[50%] h-[50%] rounded-full bg-[#EAA27C]/15 blur-[150px]" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex flex-col items-center">
        ...
        >
          ...
          >
            ...
            <span className="text-[#0E8991] dark:text-[#1bb2bd]">
          ...
          >
            <motion.button
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-2 rounded-2xl bg-[#0E8991] hover:bg-[#0C737A] text-white px-8 py-4 text-sm font-extrabold shadow-xl shadow-[#0E8991]/25 transition-all cursor-pointer"
            >
        ...
        >
            ...
            <div className="p-6 md:p-8 grid grid-cols-1 md:grid-cols-3 gap-6 bg-card">
              ...
              <div className="space-y-6 col-span-1 md:col-span-2">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="p-5 rounded-2xl bg-[#EAA27C]/15 border border-[#EAA27C]/30 flex items-center justify-between">
                    <div className="space-y-1">
              ...
              <div className="col-span-1">
                <div className="h-full rounded-2xl bg-[#0E8991]/10 border border-[#0E8991]/20 p-5 flex flex-col justify-between space-y-4">
                  <div className="space-y-3">
                    <div className="flex items-center gap-2">
                      <div className="w-9 h-9 rounded-xl bg-[#0E8991] text-white flex items-center justify-center shadow-md">
                        <Smartphone className="w-5 h-5" />
                      </div>
                      <div>
                        <h4 className="text-sm font-bold text-foreground">WhatsApp Gateway</h4>
                        <span className="text-[10px] font-bold text-[#0E8991] dark:text-[#1bb2bd] flex items-center gap-1">
                          <span className="w-1.5 h-1.5 rounded-full bg-[#0E8991] animate-pulse"></span> Terhubung (Baileys)
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="p-3.5 rounded-xl bg-card border border-border shadow-sm space-y-2">
                    <div className="flex items-center gap-2 text-xs font-bold text-foreground">
                      <Bell className="w-4 h-4 text-[#0E8991] dark:text-[#1bb2bd]" />
          ...
          <div className="absolute -inset-4 bg-[#0E8991]/10 blur-3xl opacity-60 -z-10" />
        </motion.div>
