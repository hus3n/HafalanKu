    ...
    <AnimatePresence>
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4 z-50 pointer-events-none">
        ...
        >
          ...
          {/* Info penerima */}
          <div className="bg-emerald-950/30 border border-emerald-500/20 p-3 rounded-xl text-xs space-y-1 text-emerald-200">
            <p>
              <span className="font-semibold text-emerald-300">Penerima:</span> {data.parentName} (Wali dari {data.santriName})
            </p>
            <p className="font-mono text-[11px] text-muted-foreground">
              <span className="font-semibold text-emerald-300">No. WA:</span> {data.recipientPhone} (Terenkripsi AES-256)
            </p>
          </div>
          ...
          <div className="flex-1 overflow-y-auto space-y-2">
            ...
            <div className="p-4 rounded-xl bg-background/60 border border-input text-xs font-sans whitespace-pre-wrap leading-relaxed max-h-56 overflow-y-auto">
              {data.messagePreview}
            </div>
          </div>
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              ...
              className="flex-1 h-11 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-semibold shadow-lg shadow-emerald-600/25 transition-all flex items-center justify-center gap-2"
            >
