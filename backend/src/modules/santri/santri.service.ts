...
import { santriExcelService } from './santri.excel.service';
...
export class SantriService {
  ...
  async generateImportTemplate(): Promise<Buffer> {
    return santriExcelService.generateImportTemplate();
  }
  ...
  async previewBulkImport(
    ...
    return santriExcelService.previewBulkImport(user, fileBase64);
  }
  ...
  async executeBulkImport(
    ...
    return santriExcelService.executeBulkImport(user, rows, mode);
  }
  ...
  async exportFullSantriData(
    ...
    return santriExcelService.exportFullSantriData(user, kelasId);
  }
